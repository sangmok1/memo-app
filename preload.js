...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  googleRequestCalendar: () => ipcRenderer.invoke('google-request-calendar'),
  googleLogout: () => ipcRenderer.invoke('google-logout'),
  fetchCalendarToday: (dateKey) => ipcRenderer.invoke('fetch-calendar-today', dateKey),
  exportCalendarToday: (payload) => ipcRenderer.invoke('export-calendar-today', payload),
  ...
  syncPull: (appState) => ipcRenderer.invoke('sync-pull', appState),
